          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-16">
            ...
            <div className="space-y-8">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">V327+62M, Chanesar Goth Chanesar Halt, Karachi, Karachi City, Sindh</p>
                </div>
              </div>
              <div className="flex items-start">
                <IoMdCall className="text-3xl text-black mr-4" />
                <div>
                  <h3 className="text-lg font-semibold text-gray-700">Phone</h3>
                  <p className="text-gray-600">Mobile: +(92) 304-1300451</p>
                  <p className="text-gray-600">Hotline: +(92) 318-1399799</p>
                </div>
              </div>
              <div className="flex items-start">
            ...
            <div className="bg-gray-50 p-8 rounded-lg shadow-md">
              ...
              <form className="space-y-4">
                ...
                ></textarea>
                <button className="w-full bg-yellow-300 hover:bg-yellow-400 text-black py-2 px-4 rounded shadow">
                  Submit
                </button>
              </form>
            </div>
