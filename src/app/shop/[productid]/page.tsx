        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 items-start">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="flex gap-2 mt-2">
                <button className="w-6 h-6 rounded-full bg-purple-600" aria-label="Purple color" />
                <button className="w-6 h-6 rounded-full bg-black" aria-label="Black color" />
                <button className="w-6 h-6 rounded-full bg-yellow-700" aria-label="Yellow color" />
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center border rounded-lg">
                <button className="px-4 py-2 border-r" aria-label="Decrease quantity">-</button>
                <input
                  type="number"
                  value="1"
                  readOnly
                ...
                />
                <button className="px-4 py-2 border-l" aria-label="Increase quantity">+</button>
              </div>
            ...
            <div className="space-y-2 pt-4 border-t text-sm text-gray-600">
              ...
              <div className="flex justify-between">
                ...
                <div className="flex gap-2">
                  <Link href="#" className="text-lg text-blue-600" aria-label="Share on Facebook">
                    <CiFacebook />
                  </Link>
                  <Link href="#" className="text-lg text-blue-500" aria-label="Share on LinkedIn">
                    <CiLinkedin />
                  </Link>
                  <Link href="#" className="text-lg text-pink-500" aria-label="Share on Instagram">
                    <CiInstagram />
                  </Link>
                </div>
              </div>
